...
if __name__ == '__main__':
    ...
    greg_df = pd.read_csv("/lv_local/home/niv.b/CharPDM/tommy_data.csv") #TOMMY
    greg_df = greg_df[greg_df.round_no == 4]
        ...
        for pos in tqdm(["2", "3", "4", "5"]):
            ...
            if "Exception" in str(out):
                ...
                utils.check_and_update_permissions(
                    "/lv_local/home/niv.b/content_modification_code-master/scripts/RankLib.jar")
