...
def create_paragraph_vector_files(output_dir, raw_ds_file, index_path, java_path, swig_path, home_path):
    raw_ds_file = "/lv_local/home/niv.b/content_modification_code-master/greg_output/raw_ds_tommy.txt"
...
if __name__ == "__main__":
    ...
    queries_file = "data/queries_bot_modified_sorted_tommy.xml" # TOMMY
    ...
    for POS in tqdm(poses):
        ...
        # ind_name = {-1: "5", 1: "2", -3: "3", -2: "4"}
        ind_name = {-1: "4", 1: "2", -2: "3"} #TOMMY
        ref_to_ind = {-1: 3, -2: 2, 1: 1} # make sure it is one above the  ref index
        ...
        parser.add_option("--doc_tfidf_dir", dest="doc_tfidf_dir", default="./asr_tfidf_vectors_tommy/") #TOMMY
        ...
        parser.add_option("--trec_file", dest="trec_file", default="./trecs/trec_file_original_sorted_tommy.txt") #TOMMY
        ...
        parser.add_option("--trectext_file", dest="trectext_file", default="./data/documents_tommy.trectext") #TOMMY
        ...
        if mode == "features":
            # create_paragraph_vector_files(options.doc_tfidf_dir, options.raw_ds_out, options.index_path,
            #                               options.java_path, options.swig_path, options.home_path) #TOMMY
